...
<template>
  <div
    class="min-h-screen w-full flex items-center justify-center bg-gradient-linear-2 px-4"
  >
    <div
      class="w-[556px] max-w-md rounded-2xl bg-white shadow-xl px-8 py-10 flex flex-col gap-8"
    >
      <div class=" flex justify-center  gap-6 items-center flex-col space-y-2">
        <svg
          class="w-[315px] h-[36px]"
        ...
        <p class="text-headline4 text-gray-700 font-bold">
          Admin Panel Control
        </p>
      </div>
      ...
      <div class="flex flex-col gap-6">
        ...
        <div
          v-if="isError"
          class="flex items-start gap-3 px-4 py-3 rounded-[10px] bg-purple/20 my-2"
        >
          <span
