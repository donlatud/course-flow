...
<template>
  <aside class="flex h-screen w-[240px] flex-col bg-white border-r-[1px]">
    ...
    >
      ...
      <p class="text-body2 leading-none font-normal text-gray-700">
        Admin Panel Control
      </p>
    </div>
      ...
      <div class="text-body2">
        ...
        >
          <BookOpen
            ...
            stroke-width="1.6"
          />
          <span class="text-body2 text-gray-800">Course</span>
        </RouterLink>

        <RouterLink
          to="/admin/assignment"
          :class="[menuButtonClass, isActive('/admin/assignment') ? 'bg-gray-200' : '']"
        >
          <ClipboardCheck
            :size="24"
            class="text-blue-300 transition-colors group-hover:text-blue-500"
        ...
        <RouterLink
          to="/admin/promo-code"
          :class="[menuButtonClass, isActive('/admin/promo-code') ? 'bg-gray-200' : '']"
        >
          <TicketPercent
            :size="24"
            class="text-blue-300 transition-colors group-hover:text-blue-500"
